...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['presentation_type_id'], ['ref.presentation_type.presentation_type_id'], ),
    ...
    sa.Column('country_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['country_id'], ['grape.country.country_id'], ),
    ...
    sa.ForeignKeyConstraint(['product_id'], ['catalog.product.product_id'], ),
    sa.PrimaryKeyConstraint('product_id'),
    schema='catalog'
    )
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.ForeignKeyConstraint(['region_id'], ['grape.region.region_id'], ),
    ...
    sa.ForeignKeyConstraint(['aroma_id'], ['catalog.aroma.aroma_id'], ),
    sa.ForeignKeyConstraint(['product_id'], ['catalog.wine.product_id'], ),
    ...
    sa.ForeignKeyConstraint(['grape_id'], ['grape.grape.grape_id'], ),
    sa.ForeignKeyConstraint(['product_id'], ['catalog.product.product_id'], ),
