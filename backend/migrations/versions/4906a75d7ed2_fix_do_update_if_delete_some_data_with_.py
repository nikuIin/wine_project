"""fix: do update if delete some data with id, that already exists in the delete table

Revision ID: 4906a75d7ed2
Revises: 9a1cd467a028
Create Date: 2025-07-20 23:36:15.514345
...
revision: str = "4906a75d7ed2"
down_revision: str | Sequence[str] | None = "9a1cd467a028"
...
def upgrade() -> None:
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_country_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_country_translate_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_region_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_region_translate_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_grape_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_grape_translate_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_product_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_product_translate_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_wine_category_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_wine_category_translate_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_wine_type_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_wine_type_translate_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_aroma_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_aroma_translate_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_sort_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_wine_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_wine_translate_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_aroma_wine_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_user_deleted
    ...
    op.execute("""
        ...
        """)
    op.execute("""
        create or replace trigger trigger_move_to_md_user_deleted
