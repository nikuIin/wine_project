...
import Notification, { type NotificationPosition, type NotificationType } from "@shared/ui/notifications/toast";
    ...
    <div className="relative min-h-screen p-4">
      ...
      <div className="mt-20 p-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-xl shadow-lg border border-gray-200/50 dark:border-gray-700/50">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
          ...
          <button
            onClick={() =>
              addNotification("info", "System Update", "New features are available. Check them out!", true, 5000)
            }
          ...
          <button
            onClick={() =>
              addNotification("warning", "Storage Warning", "You are running low on storage space.", true, 7000)
            }
          ...
          <button
            onClick={() =>
              addNotification("loading", "Uploading Files", "Please wait while we upload your files...", true)
            }
          ...
          <button
            onClick={() =>
              addNotification("success", "Profile Updated", "Your profile has been updated successfully.", false, 3000)
            }
          ...
          <button
            onClick={() =>
              addNotification("info", "Backup Complete", "Your data has been backed up successfully.", true, 4000)
            }
          ...
          <button
            onClick={() =>
              addNotification("warning", "Battery Low", "Your device battery is running low.", false, 6000)
            }
          ...
          <button
            onClick={() =>
              addNotification("success", "Email Sent", "Your email has been sent successfully.", true, 3000)
            }
          ...
          <button
            onClick={() =>
              addNotification("info", "New Message", "You have received a new message from John Doe.", false, 5000)
            }
          ...
          <button
            onClick={() =>
              addNotification("error", "Login Failed", "Invalid username or password. Please try again.", true, 8000)
            }
          ...
          <button
            onClick={() =>
              addNotification("info", "Sync in Progress", "Syncing your data with the cloud...", true, 6000)
            }
          ...
          <button
            onClick={() =>
              addNotification("error", "API Rate Limit", "Too many requests. Please wait 5 minutes.", true, 12000)
            }
            className="px-3 py-2 bg-red-600 dark:bg-red-700 text-white rounded-lg text-sm font-medium hover:bg-red-700 dark:hover:bg-red-800 transition-all duration-200 hover:scale-105 shadow-md"
          >
            API Rate Limit
          ...
          <button
            onClick={() =>
              addNotification("success", "Settings Saved", "Your preferences have been updated.", false, 3000)
            }
          ...
          <button
            onClick={() =>
              addNotification("info", "New Feature", "Dark mode is now available! Try it out.", true, 8000)
            }
          ...
          <button
            onClick={() =>
              addNotification("warning", "Session Expiring", "Your session will expire in 5 minutes.", true, 15000)
            }
          ...
          <button
            onClick={() =>
              addNotification("error", "Database Error", "Unable to save data. Please try again.", true, 9000)
            }
            className="px-3 py-2 bg-red-800 dark:bg-red-900 text-white rounded-lg text-sm font-medium hover:bg-red-900 dark:hover:bg-red-950 transition-all duration-200 hover:scale-105 shadow-md"
          >
            Database Error
          ...
          <button
            onClick={() =>
              addNotification("info", "Backup Started", "Starting automatic backup process...", false, 5000)
            }
          ...
          <button
            onClick={() =>
              addNotification("error", "Network Timeout", "Request timed out. Check your connection.", true, 10000)
            }
          ...
          <button
            onClick={() =>
              addNotification("loading", "Compressing Files", "Compressing your files for upload...", true)
            }
          ...
          <button
            onClick={() =>
              addNotification("info", "Meeting Reminder", "Team meeting starts in 10 minutes.", false, 8000)
            }
          ...
          <button
            onClick={() =>
              addNotification("warning", "Plugin Outdated", "Some plugins need to be updated for security.", true, 9000)
            }
          ...
          <button
            onClick={() =>
              addNotification("success", "Password Changed", "Your password has been updated successfully.", true, 4000)
            }
          ...
          <button
            onClick={() =>
              addNotification("info", "Cache Cleared", "Browser cache has been cleared successfully.", false, 3000)
            }
          ...
          <button
            onClick={() =>
              addNotification("error", "Service Unavailable", "The service is temporarily unavailable.", true, 15000)
            }
