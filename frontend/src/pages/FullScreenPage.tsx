    ...
    <>
      ...
      <main className="flex-grow content text-black dark:text-white">
        <section className="mb-8">
          ...
          <p className="mb-4">
            Используйте форматирование текста, списки и другие HTML-элементы для лучшего восприятияДля того чтобы
            работать с темами в `Tailwind CSS`, необходимо выполнить следующие шаги:
          </p>
